...
desc?: DescType;
  ...
  let { color1="#111928",color2="#2563eb",color3="#9ab7f6",color4="#c8d8fa",color5="#d6e2fb", ariaLabel="Document Folders", class: className ="shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white", height="100", title, desc, ...restProps }: Props = $props()
let ariaDescribedby = `${title?.id || ''} ${desc?.id || ''}`;
const hasDescription = $derived(!!(title?.id || desc?.id));
</script>

<svg class={className} aria-hidden="true" width="600" height="548" viewBox="0 0 600 548" fill="none" xmlns="http://www.w3.org/2000/svg" style={`height: ${height}`} aria-label={ariaLabel} aria-describedby={hasDescription ? ariaDescribedby : undefined} {...restProps}>
    ...
    {/if}
<path d="M572 274C572 425.326 449.326 548 298 548C146.674 548 24 425.326 24 274C24 122.674 146.674 0 298 0C449.326 0 572 122.674 572 274Z" fill={color5}/>
...
<path d="M502 390H435.5C468.7 326.8 559 273.333 600 254.5C574.4 317.3 524 371 502 390Z" fill={color4}/>
<path d="M445.5 390H379C412.2 326.8 509 190.5 562 147.5C544.5 231 467.5 371 445.5 390Z" fill={color4}/>
<path d="M98 390H164.5C131.3 326.8 41 273.333 0 254.5C25.6 317.3 76 371 98 390Z" fill={color4}/>
<path d="M154.5 390H221C187.8 326.8 91 190.5 38 147.5C55.5 231 132.5 371 154.5 390Z" fill={color4}/>
...
<path d="M205.672 139.85L269.855 154.39L275.301 177.156L461.433 219.324L425.86 376.345L165.459 317.352L205.672 139.85Z" fill={color5}/>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M247.819 164.266L213.197 156.422L213.639 154.471L248.261 162.315L247.819 164.266Z" fill={color2}/>
<path d="M182.973 172.88L248.243 181.287L255.818 203.436L445.103 227.815L424.536 387.496L159.724 353.389L182.973 172.88Z" fill={color5}/>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M227.239 193.201L192.03 188.666L192.285 186.683L227.494 191.218L227.239 193.201Z" fill={color2}/>
<path d="M158 213H223.81L234.151 234H425V395H158V213Z" fill={color5}/>
<path d="M158 213H223.81L234.151 234H425V395H158V213Z" fill="url(#paint5_linear_411_1556)"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M204.5 227.5H169V225.5H204.5V227.5Z" fill={color2}/>
<path d="M119 253H389L439 439H169L119 253Z" fill={color5}/>
