...
height?: string;
  ...
  let { color1="#111928",color2="#2563eb",color3="#9ab7f6",color4="#c8d8fa",color5="#d6e2fb", ariaLabel="Document Folders", class: className ="shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white",  height="100", ...restProps }: Props = $props()
</script>
