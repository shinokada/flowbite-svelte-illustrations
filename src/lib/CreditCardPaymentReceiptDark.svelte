...
height?: string;
  ...
  let { color1="#111928",color2="#1D2735",color3="#1F2A37",color4="#2563eb",color5="#2C3645",color6="#374151",color7="#6B7280",color8="#A8A8A8",color9="#F9FAFB",color10="#c8d8fa",color11="#d6e2fb", ariaLabel="Credit Card Payment Receipt Dark", class: className ="shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white",  height="100", ...restProps }: Props = $props()
</script>

<svg class={className} aria-hidden="true" width="674" height="447" viewBox="0 0 674 447" fill="none" xmlns="http://www.w3.org/2000/svg" style={`height: ${height}`} aria-label={ariaLabel} {...restProps}>
...
<path d="M6.99966 290C9.39966 298.8 47.333 353.667 65.9997 380C81.9993 398.5 131.5 372.5 131.5 358.5C131.5 344.5 124 323 122 324C120.4 324.8 115 349.333 112.5 361.5C111 348.5 71 274.5 70 280.5C69.2 285.3 79.9998 329.833 85.4997 351.5C58.333 327.333 4.59966 281.2 6.99966 290Z" fill="#1D2735"/>
...
<path d="M97.3041 55.6569C100.428 52.5327 105.494 52.5327 108.618 55.6569L266.303 213.342C269.427 216.466 269.427 221.531 266.303 224.655L174.656 316.302C171.532 319.426 166.466 319.426 163.342 316.302L5.65739 158.617C2.5332 155.493 2.53321 150.428 5.6574 147.304L97.3041 55.6569Z" fill="#374151"/>
...
<path d="M40.027 156.773C41.5891 155.211 44.1218 155.211 45.6839 156.773L68.3113 179.401C69.8734 180.963 69.8734 183.495 68.3113 185.058C66.7492 186.62 64.2166 186.62 62.6545 185.058L40.027 162.43C38.4649 160.868 38.4649 158.335 40.027 156.773Z" fill="#6B7280"/>
<path d="M72.5544 189.3C74.1165 187.738 76.6491 187.738 78.2112 189.3L100.839 211.928C102.401 213.49 102.401 216.022 100.839 217.584C99.2766 219.146 96.7439 219.146 95.1818 217.584L72.5544 194.957C70.9923 193.395 70.9923 190.862 72.5544 189.3Z" fill="#6B7280"/>
