...
>
  ...
  <rect
    ...
    rx="2"
    transform="rotate(15 175.033 411.222)"
    fill="url(#paint3_linear_275_1403)"
  />
  <path
    fill-rule="evenodd"
    clip-rule="evenodd"
