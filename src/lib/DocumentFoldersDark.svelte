...
height?: string;
  ...
  let { color1="#111928",color2="#1F2A37",color3="#2563eb",color4="#2F3948",color5="#374151",color6="#9ab7f6",color7="#c8d8fa",color8="#d6e2fb", ariaLabel="Document Folders Dark", class: className ="shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white",  height="100", ...restProps }: Props = $props()
</script>

<svg class={className} aria-hidden="true" width="600" height="548" viewBox="0 0 600 548" fill="none" xmlns="http://www.w3.org/2000/svg" style={`height: ${height}`} aria-label={ariaLabel} {...restProps}>
