...
height?: string;
  ...
  let { color1="#111928",color2="#2563eb",color3="#374151",color4="#6B7280",color5="#9ab7f6",color6="#c8d8fa",color7="#d6e2fb", ariaLabel="Laptop Server Error Dark", class: className ="shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white",  height="100", ...restProps }: Props = $props()
</script>
