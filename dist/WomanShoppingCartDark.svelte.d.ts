 ...
 * @props:ariaLabel: any = 'Woman Shopping Cart Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanShoppingCartDark: import("svelte").Component<Props, {}, "">;
type WomanShoppingCartDark = ReturnType<typeof WomanShoppingCartDark>;
export default WomanShoppingCartDark;
