 ...
 * @props:ariaLabel: any = 'Man Working Question Mark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const ManWorkingQuestionMark: import("svelte").Component<Props, {}, "">;
type ManWorkingQuestionMark = ReturnType<typeof ManWorkingQuestionMark>;
export default ManWorkingQuestionMark;
