 ...
 * @props:ariaLabel: any = 'Man Credit Card';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const ManCreditCard: import("svelte").Component<Props, {}, "">;
type ManCreditCard = ReturnType<typeof ManCreditCard>;
export default ManCreditCard;
