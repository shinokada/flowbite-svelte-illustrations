 ...
 * @props:ariaLabel: any = 'Woman Mindfulness Yoga';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanMindfulnessYoga: import("svelte").Component<Props, {}, "">;
type WomanMindfulnessYoga = ReturnType<typeof WomanMindfulnessYoga>;
export default WomanMindfulnessYoga;
