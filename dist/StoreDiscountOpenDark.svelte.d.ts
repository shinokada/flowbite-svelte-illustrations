 ...
 * @props:ariaLabel: any = 'Store Discount Open Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const StoreDiscountOpenDark: import("svelte").Component<Props, {}, "">;
type StoreDiscountOpenDark = ReturnType<typeof StoreDiscountOpenDark>;
export default StoreDiscountOpenDark;
