 ...
 * @props:color5: any = '#424D60';
 * @props:color6: any = '#9ab7f6';
 * @props:color7: any = '#B43403';
 * @props:color8: any = '#F9FAFB';
 * @props:color9: any = '#FDBA8C';
 * @props:color10: any = '#c8d8fa';
 * @props:color11: any = '#d6e2fb';
 * @props:ariaLabel: any = 'Woman Laptop Sitting Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanLaptopSittingDark: import("svelte").Component<Props, {}, "">;
type WomanLaptopSittingDark = ReturnType<typeof WomanLaptopSittingDark>;
export default WomanLaptopSittingDark;
