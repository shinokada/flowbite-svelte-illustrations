 ...
 * @props:ariaLabel: any = 'Man Credit Card Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const ManCreditCardDark: import("svelte").Component<Props, {}, "">;
type ManCreditCardDark = ReturnType<typeof ManCreditCardDark>;
export default ManCreditCardDark;
