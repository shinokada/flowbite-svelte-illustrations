 ...
 * @props:ariaLabel: any = 'Woman Laptop Standing Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanLaptopStandingDark: import("svelte").Component<Props, {}, "">;
type WomanLaptopStandingDark = ReturnType<typeof WomanLaptopStandingDark>;
export default WomanLaptopStandingDark;
