 ...
 * @props:ariaLabel: any = 'Man Repairing';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const ManRepairing: import("svelte").Component<Props, {}, "">;
type ManRepairing = ReturnType<typeof ManRepairing>;
export default ManRepairing;
