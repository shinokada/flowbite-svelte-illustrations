 ...
 * @props:ariaLabel: any = 'Employees Working Office';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const EmployeesWorkingOffice: import("svelte").Component<Props, {}, "">;
type EmployeesWorkingOffice = ReturnType<typeof EmployeesWorkingOffice>;
export default EmployeesWorkingOffice;
