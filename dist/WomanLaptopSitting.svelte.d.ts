 ...
 * @props:color6: any = '#B43403';
 * @props:color7: any = '#D6DBE2';
 * @props:color8: any = '#F9FAFB';
 * @props:color9: any = '#FDBA8C';
 * @props:color10: any = '#c8d8fa';
 * @props:color11: any = '#d6e2fb';
 * @props:ariaLabel: any = 'Woman Laptop Sitting';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanLaptopSitting: import("svelte").Component<Props, {}, "">;
type WomanLaptopSitting = ReturnType<typeof WomanLaptopSitting>;
export default WomanLaptopSitting;
