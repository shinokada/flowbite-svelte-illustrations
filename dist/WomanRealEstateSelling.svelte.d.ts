 ...
 * @props:ariaLabel: any = 'Woman Real Estate Selling';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanRealEstateSelling: import("svelte").Component<Props, {}, "">;
type WomanRealEstateSelling = ReturnType<typeof WomanRealEstateSelling>;
export default WomanRealEstateSelling;
