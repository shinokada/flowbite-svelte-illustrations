 ...
 * @props:ariaLabel: any = 'Woman Laptop Chatting Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanLaptopChattingDark: import("svelte").Component<Props, {}, "">;
type WomanLaptopChattingDark = ReturnType<typeof WomanLaptopChattingDark>;
export default WomanLaptopChattingDark;
