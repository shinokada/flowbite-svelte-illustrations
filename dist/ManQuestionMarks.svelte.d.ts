 ...
 * @props:ariaLabel: any = 'Man Question Marks';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const ManQuestionMarks: import("svelte").Component<Props, {}, "">;
type ManQuestionMarks = ReturnType<typeof ManQuestionMarks>;
export default ManQuestionMarks;
