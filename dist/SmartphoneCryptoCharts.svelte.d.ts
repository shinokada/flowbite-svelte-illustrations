 ...
 * @props:ariaLabel: any = 'Smartphone Crypto Charts';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const SmartphoneCryptoCharts: import("svelte").Component<Props, {}, "">;
type SmartphoneCryptoCharts = ReturnType<typeof SmartphoneCryptoCharts>;
export default SmartphoneCryptoCharts;
