 ...
 * @props:ariaLabel: any = 'Woman Laptop Chart Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanLaptopChartDark: import("svelte").Component<Props, {}, "">;
type WomanLaptopChartDark = ReturnType<typeof WomanLaptopChartDark>;
export default WomanLaptopChartDark;
