 ...
 * @props:ariaLabel: any = 'People Connecting Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const PeopleConnectingDark: import("svelte").Component<Props, {}, "">;
type PeopleConnectingDark = ReturnType<typeof PeopleConnectingDark>;
export default PeopleConnectingDark;
