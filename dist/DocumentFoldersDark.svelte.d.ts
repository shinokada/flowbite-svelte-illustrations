 ...
 * @props:color4: any = '#2F3948';
 * @props:color5: any = '#374151';
 * @props:color6: any = '#9ab7f6';
 * @props:color7: any = '#c8d8fa';
 * @props:color8: any = '#d6e2fb';
 * @props:ariaLabel: any = 'Document Folders Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const DocumentFoldersDark: import("svelte").Component<Props, {}, "">;
type DocumentFoldersDark = ReturnType<typeof DocumentFoldersDark>;
export default DocumentFoldersDark;
