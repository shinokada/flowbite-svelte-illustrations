 ...
 * @props:ariaLabel: any = 'Woman Exchanging Money Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanExchangingMoneyDark: import("svelte").Component<Props, {}, "">;
type WomanExchangingMoneyDark = ReturnType<typeof WomanExchangingMoneyDark>;
export default WomanExchangingMoneyDark;
