 ...
 * @props:ariaLabel: any = 'Woman Earth Hugging Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanEarthHuggingDark: import("svelte").Component<Props, {}, "">;
type WomanEarthHuggingDark = ReturnType<typeof WomanEarthHuggingDark>;
export default WomanEarthHuggingDark;
