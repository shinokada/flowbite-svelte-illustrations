 ...
 * @props:ariaLabel: any = 'Woman Reading Paper Receipt';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanReadingPaperReceipt: import("svelte").Component<Props, {}, "">;
type WomanReadingPaperReceipt = ReturnType<typeof WomanReadingPaperReceipt>;
export default WomanReadingPaperReceipt;
