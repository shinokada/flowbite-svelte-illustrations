 ...
 * @props:ariaLabel: any = 'Woman Rocket Flying Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanRocketFlyingDark: import("svelte").Component<Props, {}, "">;
type WomanRocketFlyingDark = ReturnType<typeof WomanRocketFlyingDark>;
export default WomanRocketFlyingDark;
