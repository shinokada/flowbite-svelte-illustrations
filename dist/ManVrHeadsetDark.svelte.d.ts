 ...
 * @props:ariaLabel: any = 'Man Vr Headset Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const ManVrHeadsetDark: import("svelte").Component<Props, {}, "">;
type ManVrHeadsetDark = ReturnType<typeof ManVrHeadsetDark>;
export default ManVrHeadsetDark;
