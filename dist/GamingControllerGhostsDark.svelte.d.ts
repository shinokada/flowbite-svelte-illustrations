 ...
 * ## Props
 * @props: color1: any = '#111111';
 * @props:color2: any = '#111928';
 ...
 * @props:ariaLabel: any = 'Gaming Controller Ghosts Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const GamingControllerGhostsDark: import("svelte").Component<Props, {}, "">;
type GamingControllerGhostsDark = ReturnType<typeof GamingControllerGhostsDark>;
export default GamingControllerGhostsDark;
