 ...
 * @props:ariaLabel: any = 'Woman Map Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanMapDark: import("svelte").Component<Props, {}, "">;
type WomanMapDark = ReturnType<typeof WomanMapDark>;
export default WomanMapDark;
