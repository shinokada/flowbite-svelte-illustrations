 ...
 * @props:ariaLabel: any = 'Woman Fitness Gym Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanFitnessGymDark: import("svelte").Component<Props, {}, "">;
type WomanFitnessGymDark = ReturnType<typeof WomanFitnessGymDark>;
export default WomanFitnessGymDark;
