 ...
 * @props:ariaLabel: any = 'Smartphone Charts Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const SmartphoneChartsDark: import("svelte").Component<Props, {}, "">;
type SmartphoneChartsDark = ReturnType<typeof SmartphoneChartsDark>;
export default SmartphoneChartsDark;
