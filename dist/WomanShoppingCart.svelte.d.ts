 ...
 * @props:ariaLabel: any = 'Woman Shopping Cart';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanShoppingCart: import("svelte").Component<Props, {}, "">;
type WomanShoppingCart = ReturnType<typeof WomanShoppingCart>;
export default WomanShoppingCart;
