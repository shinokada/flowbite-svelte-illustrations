 ...
 * @props:ariaLabel: any = 'Man Car Service Repairing Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const ManCarServiceRepairingDark: import("svelte").Component<Props, {}, "">;
type ManCarServiceRepairingDark = ReturnType<typeof ManCarServiceRepairingDark>;
export default ManCarServiceRepairingDark;
