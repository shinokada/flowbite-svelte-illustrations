 ...
 * @props:ariaLabel: any = 'Woman Vr Headset';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanVrHeadset: import("svelte").Component<Props, {}, "">;
type WomanVrHeadset = ReturnType<typeof WomanVrHeadset>;
export default WomanVrHeadset;
