 ...
 * @props:ariaLabel: any = 'Woman Scooter Transporting Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanScooterTransportingDark: import("svelte").Component<Props, {}, "">;
type WomanScooterTransportingDark = ReturnType<typeof WomanScooterTransportingDark>;
export default WomanScooterTransportingDark;
