 ...
 * @props:color5: any = '#F4F7FB';
 * @props:color6: any = '#F9FAFB';
 * @props:color7: any = '#FDBA8C';
 * @props:color8: any = '#c8d8fa';
 * @props:color9: any = '#d6e2fb';
 * @props:ariaLabel: any = 'Woman Shopping Window';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanShoppingWindow: import("svelte").Component<Props, {}, "">;
type WomanShoppingWindow = ReturnType<typeof WomanShoppingWindow>;
export default WomanShoppingWindow;
