 ...
 * @props:ariaLabel: any = 'Man Vr Headset';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const ManVrHeadset: import("svelte").Component<Props, {}, "">;
type ManVrHeadset = ReturnType<typeof ManVrHeadset>;
export default ManVrHeadset;
