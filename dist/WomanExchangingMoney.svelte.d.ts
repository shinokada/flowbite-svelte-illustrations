 ...
 * @props:ariaLabel: any = 'Woman Exchanging Money';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanExchangingMoney: import("svelte").Component<Props, {}, "">;
type WomanExchangingMoney = ReturnType<typeof WomanExchangingMoney>;
export default WomanExchangingMoney;
