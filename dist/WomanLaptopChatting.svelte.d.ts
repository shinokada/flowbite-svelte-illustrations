 ...
 * @props:color5: any = '#FDBA8C';
 * @props:color6: any = '#c8d8fa';
 * @props:color7: any = '#d6e2fb';
 * @props:ariaLabel: any = 'Woman Laptop Chatting';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanLaptopChatting: import("svelte").Component<Props, {}, "">;
type WomanLaptopChatting = ReturnType<typeof WomanLaptopChatting>;
export default WomanLaptopChatting;
