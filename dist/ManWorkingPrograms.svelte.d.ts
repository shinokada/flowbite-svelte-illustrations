 ...
 * @props:ariaLabel: any = 'Man Working Programs';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const ManWorkingPrograms: import("svelte").Component<Props, {}, "">;
type ManWorkingPrograms = ReturnType<typeof ManWorkingPrograms>;
export default ManWorkingPrograms;
