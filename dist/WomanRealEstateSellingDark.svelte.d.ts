 ...
 * @props:ariaLabel: any = 'Woman Real Estate Selling Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanRealEstateSellingDark: import("svelte").Component<Props, {}, "">;
type WomanRealEstateSellingDark = ReturnType<typeof WomanRealEstateSellingDark>;
export default WomanRealEstateSellingDark;
