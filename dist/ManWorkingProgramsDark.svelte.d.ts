 ...
 * @props:ariaLabel: any = 'Man Working Programs Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const ManWorkingProgramsDark: import("svelte").Component<Props, {}, "">;
type ManWorkingProgramsDark = ReturnType<typeof ManWorkingProgramsDark>;
export default ManWorkingProgramsDark;
