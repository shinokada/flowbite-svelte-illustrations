 ...
 * @props:ariaLabel: any = 'Woman Cyber Security';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanCyberSecurity: import("svelte").Component<Props, {}, "">;
type WomanCyberSecurity = ReturnType<typeof WomanCyberSecurity>;
export default WomanCyberSecurity;
