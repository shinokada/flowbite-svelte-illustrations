 ...
 * @props:ariaLabel: any = 'Woman Tutoring Classroom';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanTutoringClassroom: import("svelte").Component<Props, {}, "">;
type WomanTutoringClassroom = ReturnType<typeof WomanTutoringClassroom>;
export default WomanTutoringClassroom;
