 ...
 * @props:ariaLabel: any = 'Woman Laptop Standing';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanLaptopStanding: import("svelte").Component<Props, {}, "">;
type WomanLaptopStanding = ReturnType<typeof WomanLaptopStanding>;
export default WomanLaptopStanding;
