 ...
 * @props:ariaLabel: any = 'Man Review Stars';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const ManReviewStars: import("svelte").Component<Props, {}, "">;
type ManReviewStars = ReturnType<typeof ManReviewStars>;
export default ManReviewStars;
