 ...
 * @props:ariaLabel: any = 'Man Question Marks Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const ManQuestionMarksDark: import("svelte").Component<Props, {}, "">;
type ManQuestionMarksDark = ReturnType<typeof ManQuestionMarksDark>;
export default ManQuestionMarksDark;
