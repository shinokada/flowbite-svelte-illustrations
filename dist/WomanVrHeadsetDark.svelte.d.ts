 ...
 * @props:ariaLabel: any = 'Woman Vr Headset Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] text-gray-800 dark:text-white';
 * @props:height: any = '100';
 * @props:title: any;
 * @props:desc: any;
 */
declare const WomanVrHeadsetDark: import("svelte").Component<Props, {}, "">;
type WomanVrHeadsetDark = ReturnType<typeof WomanVrHeadsetDark>;
export default WomanVrHeadsetDark;
