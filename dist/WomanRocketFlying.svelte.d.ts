 ...
 * @props:ariaLabel: any = 'Woman Rocket Flying';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanRocketFlying: import("svelte").Component<Props, {}, "">;
type WomanRocketFlying = ReturnType<typeof WomanRocketFlying>;
export default WomanRocketFlying;
