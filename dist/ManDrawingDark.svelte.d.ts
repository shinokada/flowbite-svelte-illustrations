 ...
 * @props:ariaLabel: any = 'Man Drawing Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const ManDrawingDark: import("svelte").Component<Props, {}, "">;
type ManDrawingDark = ReturnType<typeof ManDrawingDark>;
export default ManDrawingDark;
