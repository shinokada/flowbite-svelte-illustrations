 ...
 * @props:ariaLabel: any = 'Woman Cyber Security Dark';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanCyberSecurityDark: import("svelte").Component<Props, {}, "">;
type WomanCyberSecurityDark = ReturnType<typeof WomanCyberSecurityDark>;
export default WomanCyberSecurityDark;
