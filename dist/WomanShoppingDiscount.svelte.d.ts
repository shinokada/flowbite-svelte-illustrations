 ...
 * @props:ariaLabel: any = 'Woman Shopping Discount';
 * @props:class: string = 'shrink-0 w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white';
 * @props:height: any = '100';
 */
declare const WomanShoppingDiscount: import("svelte").Component<Props, {}, "">;
type WomanShoppingDiscount = ReturnType<typeof WomanShoppingDiscount>;
export default WomanShoppingDiscount;
